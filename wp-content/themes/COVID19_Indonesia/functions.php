...
add_action("wp_before_admin_bar_render", "remove_logo");
...
add_action("wp_dashboard_setup", "setup_dashboard");

function login_scripts()
{ ?>
    <style>
        body.login #login h1 a {
            background-image: url("<?= get_template_directory_uri() ?>/dist/img/1.jpg");
        ...
        body.login {
            background-image: url("<?= get_template_directory_uri() ?>/dist/img/5.jpg");
            background-position: center;
            background-repeat: no-repeat;
            background-size: cover;
        }
